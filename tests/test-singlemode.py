...
if __name__ == '__main__':
    ...
    start_index_d = np.argmin(np.abs(wavelength_nm - start_wvl_d))
    end_index_d = np.argmin(np.abs(wavelength_nm - end_wvl_d))
    start_index_s = np.argmin(np.abs(wavelength_nm - start_wvl_s))
    end_index_s = np.argmin(np.abs(wavelength_nm - end_wvl_s))

    print(f"Start index: {start_index_d}")
    print(f"End index: {end_index_d}")
    print(f"Start index: {start_index_s}")
    print(f"End index: {end_index_s}")
