...
if __name__ == '__main__':
    ...
    initial_fields_gt = np.load('./data/initial_pulse_raman.npy')
    output_fields_gt = np.load('./data/output_pulse_raman.npy')
    ...
    plt.plot(wvls_nm, initial_spectrum[0], label='initial', alpha=0.8, linewidth=2.0)
    plt.plot(wvls_nm, output_spectrum[0], label='output', alpha=0.8, linewidth=2.0)
