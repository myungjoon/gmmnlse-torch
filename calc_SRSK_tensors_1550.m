...
Nx = 64; % number of spatial grid points for each mode
linear_yes = 1; % 1 = linear polarization, 0 = circular polarization
gpu_yes = 0; % 1 = run on GPU, 0 = run on CPU
single_yes = 1; % 1 = single precision, 0 = double precision
dir_prefix = 'GRIN_1550_FMF'; % folder containing the calculated modes

% File name parameters, as strings:
lambda0 = '1550'; % center wavelength in nm
radius = '8';
boundary = '0000';
